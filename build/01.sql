...
CREATE TABLE IF NOT EXISTS `main_data` (
	...
	`datatype` CHAR(10) NOT NULL DEFAULT 'text',
	`subject` VARCHAR(250) CHARACTER SET ut8 COLLATE utf8_general_ci NOT NULL,
	`summary` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
	`text` TEXT CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
	`owner` SMALLINT UNSIGNED NOT NULL,
	`sendTo` SMALLINT UNSIGNED DEFAULT NULL,
